...
contract ProjectName is AutomationCompatibleInterface, ERC721URIStorage, Ownable {
    ...
    // function getEventName(string calldata eventName) public view returns (string memory){
    ...
    function safeMint(string memory eventName, address payable to) public payable {
    ...
    function transferBalance(address payable recipient, uint256 _interval) public {
